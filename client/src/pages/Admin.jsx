...
import { Shield, ChefHat, LogOut, ArrowLeft, Users, Lightbulb, LayoutDashboard } from 'lucide-react';
...
const Admin = () => {
    ...
    return (
        <div className="min-h-screen bg-stone-50 dark:bg-stone-950 transition-colors duration-300 font-sans">
            {/* Header */}
            <header className="bg-white dark:bg-stone-900 border-b border-stone-200 dark:border-stone-800 px-6 py-4 sticky top-0 z-30 transition-colors duration-300">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-stone-800 dark:text-stone-100 leading-none">Admin Panel</h1>
                                <p className="text-xs text-stone-500 dark:text-stone-400 mt-1">Manage your cookbook</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-right hidden md:block">
                            <p className="text-sm font-semibold text-stone-800 dark:text-stone-200">{user?.username || 'Admin'}</p>
            ...
            <div className="bg-white dark:bg-stone-900 border-b border-stone-200 dark:border-stone-800 transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-6 flex gap-1 overflow-x-auto hide-scrollbar">
                    {[
                        ...
                        <NavLink
                            key={tab.path}
                            to={tab.path}
                            className={({ isActive }) => `flex items-center gap-2 px-6 py-4 font-medium text-sm transition-all relative ${
                                isActive
